...
export const STAFF = [
  ...
  { id: "u3", name: "Pete H?pai", initials: "PH", role: "Driller",              supervisor: "Kevin Lam",      division: "Geotech", region: "North" },
...
export const TIMESHEETS = [
  ...
  {
    id: "ts-003", userId: "u3", user: "Pete H?pai", weekStart: "2026-03-09",
    ...
    days: [
      { date: "2026-03-09", dayType: "work", overnight: false, entries: [
          { jobId: "200029", hours: 9, rateType: "ordinary",  notes: "CPT testing SH73 Site C", crewWith: ["James T?hoe"] },
        ]},
      { date: "2026-03-08", dayType: "work", overnight: false, entries: [
          { jobId: "200029", hours: 9, rateType: "ordinary",  notes: "", crewWith: ["James T?hoe"] },
        ]},
      { date: "2026-03-07", dayType: "work", overnight: true, entries: [
          { jobId: "200029", hours: 9, rateType: "ordinary",  notes: "Overnight Auckland", crewWith: ["James T?hoe"] },
        ]},
      { date: "2026-03-06", dayType: "work", overnight: true, entries: [
          { jobId: "200029", hours: 9, rateType: "ordinary",  notes: "Overnight Auckland", crewWith: ["James T?hoe"] },
        ]},
...
export const fmt = (n) => n != null ? `$${n.toLocaleString("en-NZ")}` : "?";
...
export const fmtCost = (n) => n > 0 ? `$${n.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}` : "?";
...
export const UNIT_OPTIONS = ["ea", "ls", "hr", "day", "m", "m?", "m?", "bag", "t", "week"];
...
export const INSPECTIONS_DATA = [
  ...
  { id: "ins-401", eqId: "eq4", date: "2026-03-07", tech: "Pete H?pai", faults: ["Drill rod thread wear ? 2 rods flagged"], status: "open", priority: "medium", notes: "Flagged for replacement on return to yard" },
  { id: "ins-402", eqId: "eq4", date: "2026-02-28", tech: "Pete H?pai", faults: [], status: "pass", priority: null, notes: "" },
  { id: "ins-403", eqId: "eq4", date: "2026-02-21", tech: "Pete H?pai", faults: ["CPT cone calibration drift ? +2.3% on ref load"], status: "resolved", priority: "medium", notes: "Recalibrated by GNS 2026-02-24" },
...
export const PLANNER_JOBS = [
  ...
  { rigId: "eq4", jobId: "200029", client: "NZTA", site: "SH73, West Auckland", start: "2026-01-20", end: "2026-04-30", color: COLORS.teal, personnel: ["Pete H?pai", "James T?hoe"] },
...
export const TIMESHEET_DETAIL = [
  ...
  { week: "2026-02-09", user: "Pete H?pai", job: "200029", hours: 44, role: "Driller" },
  ...
  { week: "2026-02-16", user: "Pete H?pai", job: "200029", hours: 44, role: "Driller" },
  ...
  { week: "2026-02-23", user: "Pete H?pai", job: "200029", hours: 45, role: "Driller" },
  ...
  { week: "2026-03-02", user: "Pete H?pai", job: "200029", hours: 44, role: "Driller" },
